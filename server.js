...
admin.initializeApp({
  credential: admin.credential.cert({
    ...
    client_email:
      "firebase-adminsdk-rhm7m@record-catalog.iam.gserviceaccount.com",
    client_id: "103139671292416566092",
    auth_uri: "https://accounts.google.com/o/oauth2/auth",
    token_uri: "https://oauth2.googleapis.com/token",
    auth_provider_x509_cert_url: "https://www.googleapis.com/oauth2/v1/certs",
    client_x509_cert_url:
      "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-rhm7m%40record-catalog.iam.gserviceaccount.com",
  }),
});
